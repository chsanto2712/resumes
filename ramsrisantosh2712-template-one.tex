    ...
    \section{Projects}
        ...
        \section{Certifications}
          \begin{itemize}[leftmargin=0.45in,label={}]
              ...
              \item[\textbullet{}]\href{sadas}{sadasds (\emph{adasdsad $|$ adasd})} \faExternalLink
              \newline 
              \vspace{-20pt}
          \vspace{8pt}
          \end{itemize}
          ...
          \begin{itemize}[leftmargin=0.15in, label={}]
            \item[]
              ...
              \textbf{sdfsdfsd $|$ \emph{undefined} } \hfill{[object Object]}
              \begin{itemize}[leftmargin=0.15in, label={}]
                \textbullet{} dfsdfds 
                \newline
              \end{itemize}
              
              \textbf{sdfsdfsdf $|$ \emph{undefined} } \hfill{[object Object]}
              \begin{itemize}[leftmargin=0.15in, label={}]
                \textbullet{} fsdfsd 
                \newline
              \end{itemize}
