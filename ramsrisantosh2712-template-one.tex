    ...
    \begin{center}
        {\Huge \scshape Santhoshsdsd} \\ \vspace{1pt}
        \large fdgdgdfg \\ \vspace{1pt}
        \href{mailto:email.com}{\raisebox{-0.05\height}\faEnvelope \ email.com} 
         \
