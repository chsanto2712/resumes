    ...
    \begin{minipage}[t]{0.5\textwidth} 
      ...
      { \fontsize{16}{20} \textcolor{black}{\textbf{\phvfont{knh klsdfsdfks}}}} 
      
      \vspace{10pt}
      \begin{minipage}[t]{0.9\textwidth}
        \phvfont{\small ffcxvxcvsdfsadfg}
      \end{minipage}
    ...
    \vspace{2pt}
    \faGlobe \hspace{2pt} \textmd{\phvfont{{\href{ebsite}{ebsite}}}} \\ 
      \vspace{2pt}
    ...
    \begin{minipage}[t]{0.3\textwidth}
      ...
      \faEnvelope \hspace{2pt} {\href{mailto:email}{email}} \\	
