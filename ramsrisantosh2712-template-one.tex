    ...
    \begin{center}
      ...
      \textbf{\large Headling} \\ \vspace{2pt}
      \href{mailto:sdf}{\raisebox{-0.05\height}\faEnvelope \ sdf} 
    ...
    \end{center}
      ...
      \section{Career Objective}
        \begin{itemize}[leftmargin=0.15in, label={}]
          \item{jkdsgfhjksdhdsgfdsgsdfdsffdgddgsdgfgdfgdgfgdfgdsfsdffdfdg}
        \end{itemize}
    ...
    \section{Projects}
        ...
        egin{itemize}[leftmargin=0.15in,label={}]
        item{
        ...
        item{
          ...
          $|$ href{https://github.com/GSK-10/Placement_Prediction}{({Code} aExternalLink)}
        ...
        item{
          ...
          }$|$ emph{HTML $|$ CSS $|$ PHP $|$ MySQL} $|$ href{https://github.com/GSK-10/Online_Music_Store}{({Code} aExternalLink)}
          } hfill Jan 2023
          egin{itemize}
