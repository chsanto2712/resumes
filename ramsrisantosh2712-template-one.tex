    ...
    \begin{center}
      \textbf{\Huge \scshape sdfsdfdsf} \\ \vspace{5pt}
      \textbf{\large dfsdfdsfsdf} \\ \vspace{2pt}
    ...
    \section{Education}
        ...
        \begin{itemize}[leftmargin=0.15in, label={}]
        \item[]
          \textbf{ sdfsdfsdf } \hfill sdfsdfd \\
          \textit{ dsfsdf in sdf } \hfill dsfsdf 
        \end{itemize}
        \vspace{-15pt}
