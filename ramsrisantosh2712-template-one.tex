    ...
    \end{center}
      ...
      \section{Career Objective}
        \begin{itemize}[leftmargin=0.15in, label={}]
          \item{sdfdsfsdfdfddfssfsdfgdasdasdsdfsdfassdfsdfdasdsdfsdf}
        \end{itemize}
        ...
        \begin{itemize}[leftmargin=0.15in,label={}]
          ...
          \begin{itemize}[leftmargin=0.15in, label={}]
            \item[]
              ...
              \textbf{Software Engineer $|$ \emph{Zebu} } \hfill{March 2023 - Sept 2024}
              \begin{itemize}[leftmargin=0.15in, label={}]
                \textbullet{} Won Cake to eat 
                \newline
              \end{itemize}
              
              \textbf{Volenteer $|$ \emph{Computer Society of India} } \hfill{Today}
              \begin{itemize}[leftmargin=0.15in, label={}]
                \textbullet{} I won the medal 
                \newline
              \end{itemize}
