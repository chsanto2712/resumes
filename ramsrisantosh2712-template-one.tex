    ...
    \end{center}
      ...
      \begin{itemize}[leftmargin=0in, label={}]
            ...
            \item[]
                \textbf{ZEBU INTELLIGENT SYSTEMS} \hfill \textbf{Sept 2023 - Present} \\
                \textit{Software Engineering Intern} \hfill  City, State  
                \vspace*{-2mm}
                \begin{itemize}
                \vspace{-5pt}
                \item[\textbullet{}]\textbf{Developed} a project 
                \vspace{-5pt}
                \item[\textbullet{}]\textbf{Developed} a project     
                \end{itemize}
