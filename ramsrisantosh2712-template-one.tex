    ...
    \end{center}
      ...
      \section{Career Objective}
        \begin{itemize}[leftmargin=0.15in, label={}]
          \item{dsfdsfggffgdfvsdfgdfdgfdfgfgsadsfsdsfsdfasddsfsddffsaddfdsfdsfsddfgdfgfsdfsddfdffgffgfggfgfgfgfdgdfg}
        \end{itemize}
    ...
    \section{Projects}
        ...
        \begin{itemize}[leftmargin=0.15in,label={}]
            ...
            \item[]
            \textbf{COMPANY $|$ \emph{Position}} $|$ \href{Linl}{({Code} \faExternalLink)} \hfill Date Range
            \begin{itemize}
