    ...
    \end{center}
      ...
      \section{Career Objective}
        \begin{itemize}[leftmargin=0.15in, label={}]
          \item{fdgdfgsfsdafdsfsdfdsfdsfdsasdasdddsfssdfd}
        \end{itemize}
    ...
    \section{Projects}
        ...
        \begin{itemize}[leftmargin=0.15in,label={}]
          ...
          \item{
            \textbf{SDFSDFSDVC} $|$ \emph{fsd} $|$ \emph{sdfsdf} $|$  \href{sdfsdfsdfsdf} {({Code} \faExternalLink)}
            \hfill 
          }
            \begin{itemize}
            \vspace{-5pt}
            \item[\textbullet{}]\textbf{sdfsdfsd}  
            \vspace{-5pt}
            \item[\textbullet{}]\textbf{fsdfsdfsd}              
            \end{itemize}
