    ...
    \end{center}
      ...
      \section{Career Objective}
        \begin{itemize}[leftmargin=0.15in, label={}]
          \item{dckfdfsddfgdgfddsfdfsdfvcbbgvbfdgdffgfgdgfdsfdfoirehfgDFG}
        \end{itemize}
    ...
    \section{Projects}
        ...
        \begin{itemize}[leftmargin=0.15in,label={}]
          ...
          \item{
            \textbf{1} $|$ \emph{6} $|$ \emph{5} $|$ \emph{4} $|$ \emph{7} $|$ \emph{8} $|$ \emph{9} $|$ \emph{32} $|$ \emph{.} $|$ \emph{2} $|$  \href{3} {({Code} \faExternalLink)}
            \hfill 2
          }
          \begin{itemize}
            \vspace{-5pt}
