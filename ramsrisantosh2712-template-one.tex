    ...
    \end{center}
      ...
      \section{Career Objective}
        \begin{itemize}[leftmargin=0.15in, label={}]
          \item{Santhoshdsfdsgfsadfsadfdfdsfsdsdsadfssddfdfgfdgguhjjhfsdflikhjfhjjhhjudeffdgdfgh}
        \end{itemize}
    ...
    \begin{itemize}[leftmargin=0.15in, label={}]
        \item[]
        \textbf{Volunteer $|$ \emph{Computer Society of India} } \hfill{2021}
        \begin{itemize}
            ...
            \end{itemize}
            \textbf{Volunteer $|$ \emph{Computer Society of India} }{2021}
