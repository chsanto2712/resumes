    ...
    \begin{minipage}[t]{0.5\textwidth} 
      ...
      { \fontsize{16}{20} \textcolor{black}{\textbf{\phvfont{knh klsdfsd}}}} 
      
      \vspace{10pt}
      \begin{minipage}[t]{0.9\textwidth}
        \phvfont{\small ffcxvxcvsdfsad}
      \end{minipage}

    \end{minipage}
    \hfill 
    \begin{minipage}[t]{0.18\textwidth} 
    \hspace{0pt}{} \faPhone \hspace{2pt} phone \\
    \vspace{2pt}
    \faGlobe \hspace{2pt} \textmd{\phvfont{{\href{ebsite}{porta}}}} \\ 
      \vspace{2pt}
      \faMapMarker \hspace{2pt} locsdtfgff \\
    
    \end{minipage}
    \begin{minipage}[t]{0.3\textwidth}
      \vspace{-\baselineskip}
      
      \faEnvelope \hspace{2pt} {\href{mailto:em}{em}} \\	
