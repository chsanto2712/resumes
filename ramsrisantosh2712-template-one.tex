    ...
    \end{center}
      ...
      \section{Career Objective}
        \begin{itemize}[leftmargin=0.15in, label={}]
          \item{jkdsgfhjksdhdsgfdsgsdfdsffdgddgsdgfgdfgdgfgdfgdsfsdfgdfgffdfdgdsfddgfdg}
        \end{itemize}
    ...
    \section{Projects}
        ...
        \begin{itemize}[leftmargin=0.15in,label={}]
          ...
          \item{
            \textbf{DSFDSF} $|$ \emph{A} $|$\emph{1} $|$\emph{2} $|$\emph{3} $|$\emph{4} $|$\emph{5} $|$\emph{6} $|$\emph{7} $|$\emph{8} $|$\emph{9} $|$
            \hfill March 2020 - December 2020
          }
          \begin{itemize}
