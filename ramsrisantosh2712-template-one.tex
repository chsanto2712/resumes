...
\end{itemize}
    ...
    \begin{itemize}
      ...
      \newline
      \hspace*{80pt}
        \textbullet Enrolled, part-time program for development Lorem ipsum dolor sit amet \\
        \hspace*{80pt}
        \textbullet It has survived not only five centuries, but also the leap into electronic typesetting,
        \item[]
        {x/2023 - x/2023}
        \hspace*{6pt}
        {\textbf{Lorem ipsum dolor sit amet, consectetur adipiscing elit,}}  \hfill Company
        \newline
        \hspace*{80pt}
        \textbullet Many desktop publishing packages and web page editors now use  \\
        \hspace*{80pt}
        \textbullet There are many variations of passages of Lorem Ipsum available,
      \item[]
        {x/2023 - x/2023}
        \hspace*{6pt}
        {\textbf{Lorem ipsum dolor sit amet, consectetur adipiscing elit,}}  \hfill		Company
        \newline
        \hspace*{80pt}
        \textbullet Lorem Ipsum is therefore always free from repetition, injected humour,\\
        \hspace*{80pt}
        \textbullet  Lorem ipsum dolor sit amet.., comes from a line in section 1.10.32.
    \end{itemize}
