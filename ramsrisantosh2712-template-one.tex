    ...
    \begin{center}
      \textbf{\Huge \scshape SANTTHOSH} \\ \vspace{5pt}
    ...
    \section{Projects}
        ...
        \begin{itemize}[leftmargin=0.15in,label={}]
          ...
          \item{
            \textbf{FGDGDFG} $|$ \emph{fgdfg} $|$ \\emph{fgfg} $|$ \ \href{https://github.com/chsanto2712/resumes/blob/main/file.tex} {({Code} \faExternalLink)}
            \hfill fgdfg
          }
          \begin{itemize}
            \item[\textbullet{}]\textbf{} a full-stack web application for the college’s CSE department to store and manage publications.
