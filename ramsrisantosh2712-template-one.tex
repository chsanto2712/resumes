    ...
    \begin{center}
      \textbf{\Huge \scshape Santghosh} \\ \vspace{5pt}
      \textbf{\large HeadlinHeadline} \\ \vspace{2pt}
    ...
    \section{Education}
      ...
      ,
        \begin{itemize}
        \item
          \textbf{ COllege } \hfill Course Date \\
          \textit{ Study in Area } \hfill Score 
        \end{itemize}
        \vspace{-15pt}
