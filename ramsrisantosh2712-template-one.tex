    ...
    \section{Projects}
        ...
        \begin{itemize}[leftmargin=0.15in,label={}]
            ...
            \begin{itemize}
              \vspace{-5pt}
              \item[\textbullet{}]\textbf{Developed} a company website 
              \vspace{-5pt}
              \item[\textbullet{}]\textbf{Its} a completely Responsive application             
            \end{itemize}
            \item[]
            \textbf{ABCDEFGHI $|$ \emph{ABCDEFGHI}} $|$ \href{ABCDEFGHI}{({Code} \faExternalLink)} \hfill ABCDEFGHI
            \begin{itemize}
              \vspace{-5pt}
              \item[\textbullet{}]\textbf{ABCDEFGHI}  
              \vspace{-5pt}
              \item[\textbullet{}]\textbf{ABCDEFGHI}              
            \end{itemize}
      \end{itemize}
