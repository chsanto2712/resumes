    ...
    \end{center}
      ...
      \section{Career Objective}
        \begin{itemize}[leftmargin=0.15in, label={}]
          \item{sdfsdffdgdsdfsdfdfsddfdfdsfdfdfdfdffgdfdffdgffdgdfdfdfdffgdgdffd}
        \end{itemize}
    ...
    \section{Projects}
        ...
        \section{Certifications}
          \begin{itemize}[leftmargin=0.15in,label={}]
              ...
              \item[\textbullet{}]\href{dsfsdf}{sdfdsf (\emph{dsfsdf $|$ sdf})} \faExternalLink
              \newline 
              \vspace{-20pt}
              \item[\textbullet{}]\href{dfsdfsd}{sdfsdfsdf (\emph{sdfdf $|$ sfsdfdf})} \faExternalLink
              \newline 
              \vspace{-20pt}
