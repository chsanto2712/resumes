    ...
    \begin{center}
      \textbf{\Huge \scshape fdgdfgdfg} \\ \vspace{5pt}
      
      \href{mailto:mail@mail.com}{\raisebox{-0.05\height}\faEnvelope \ Your Mail} 
      \ $|$ \ \href{tel:fgdfg}{\raisebox{-0.05\height}\faMobile \ fgdfg}  \
       \
       \
    ...
    \section{Projects}
        ...
        \begin{itemize}[leftmargin=0.15in,label={}]
          ...
          \item[]
              ...
              \textbf{dfgdfgdfg $|$ \emph{gfdgdfgdf} } \hfill{gdfgdf}
              \begin{itemize}[leftmargin=0.15in, label={}]
                \textbullet{} gdfg 
                \newline
              \end{itemize}
              
              \textbf{dfgdfg $|$ \emph{gdfgdg} } \hfill{dfgdfgdf}
              \begin{itemize}[leftmargin=0.15in, label={}]
                \textbullet{} dgdfg 
                \newline
              \end{itemize}
