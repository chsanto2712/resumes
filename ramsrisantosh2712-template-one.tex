   ...
   \section{Education}
    ...
    \begin{itemize}[leftmargin=0in, label={}]
        \item[]
            ...
            \vspace*{-2mm}
            \begin{itemize}
                \item[\sbt] Developed a service to automatically perform a set of unit tests daily on a product in development in order to decrease time needed for team members to identify and fix bugs/issues. \vspace*{-1mm}
