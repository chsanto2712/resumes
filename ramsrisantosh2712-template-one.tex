...
\end{minipage}
    ...
    \begin{entrylist}
      ...
      \entry
        {\emph{CSS}, \emph{Html}, \emph{JAVA}, \emph{JS}, \emph{C++}, \emph{C}, \emph{C Sharp}, \emph{Golang}}
        {DFGDFGDF}
        {dfgdfg}
        {fgdfgdfgdfgdfgsdfsf skdfs fisdf sd fknsdf sdf smd f  sdf   s df   sdf
        jkdfsd fsdf sdfsdf fsdfs fdhf sdfshdfsdjf sdfhjk }
